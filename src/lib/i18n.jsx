...
const DICT = {
  es: {
    ...
    'home.tagline': 'Conectando necesidades, recursos y ayuda en tiempo real.',
    'home.subtitle': 'Mapa colaborativo de la respuesta al terremoto del 24 de junio en Distrito Capital, Miranda y La Guaira.',
    'home.explore': 'Explorar el mapa',
    'home.stat.points': 'Puntos registrados',
    'home.stat.verified': 'Puntos verificados',
    'home.stat.updates': 'Actualizaciones recientes',
    'home.stat.active': 'Centros de ayuda activos',
    'home.intro.hide': 'Ocultar',
    'home.intro.show': 'Información',

    'whatsapp.cta': 'Reportar por WhatsApp',
    'whatsapp.title': 'Reporta por WhatsApp',
    'whatsapp.desc': '¿Tienes información sobre una necesidad, hospital, refugio o centro de acopio? Envíanos un mensaje por WhatsApp para que nuestro equipo pueda revisarlo y agregarlo al mapa.',
    'whatsapp.soon': 'Integración disponible próximamente',
    ...
    'about.body1': 'Mapa de Ayuda conecta comunidades, hospitales, centros de acopio, refugios, voluntarios y organizaciones para facilitar la coordinación de recursos durante situaciones de emergencia.',
    'about.body2': 'La plataforma permite visualizar necesidades en tiempo real, registrar puntos de ayuda, compartir actualizaciones y conectar donaciones con los lugares donde más se necesitan.',
    'about.body3': 'La información es colaborativa y es revisada por administradores antes de ser publicada. Nuestro objetivo es ayudar a que recursos, información y apoyo lleguen más rápido a las personas y comunidades afectadas.',
    ...
    'footer.tagline': 'Información colaborativa de referencia. Verifica antes de actuar.',
  ...
  en: {
    ...
    'home.tagline': 'Connecting needs, resources and aid in real time.',
    'home.subtitle': 'Collaborative map of the response to the June 24 earthquake in Distrito Capital, Miranda and La Guaira.',
    'home.explore': 'Explore the map',
    'home.stat.points': 'Registered points',
    'home.stat.verified': 'Verified points',
    'home.stat.updates': 'Recent updates',
    'home.stat.active': 'Active aid centers',
    'home.intro.hide': 'Hide',
    'home.intro.show': 'Info',

    'whatsapp.cta': 'Report via WhatsApp',
    'whatsapp.title': 'Report via WhatsApp',
    'whatsapp.desc': 'Do you have information about a need, hospital, shelter or collection center? Send us a WhatsApp message so our team can review it and add it to the map.',
    'whatsapp.soon': 'Integration coming soon',
    ...
    'about.body1': 'Mapa de Ayuda connects communities, hospitals, collection centers, shelters, volunteers and organizations to facilitate the coordination of resources during emergencies.',
    'about.body2': 'The platform lets you visualize needs in real time, register aid points, share updates and connect donations with the places that need them most.',
    'about.body3': 'Information is collaborative and reviewed by administrators before being published. Our goal is to help resources, information and support reach affected people and communities faster.',
    ...
    'about.how4': 'Aid centers can update their needs and available resources.',
    'about.how5': 'Donors and volunteers can identify where to help.',
    'about.types': 'Types of points',

    'footer.tagline': 'Collaborative reference information. Verify before acting.',
    'footer.about': 'About',
